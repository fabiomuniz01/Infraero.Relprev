...
namespace Infraero.Relprev.WebApi.IntegrationTests
{
    public class CustomWebApplicationFactory<TStartup> : WebApplicationFactory<TStartup> where TStartup : class
    {
        ...
        {
            return await GetAuthenticatedClientAsync("jason@clean-architecture", "Infraero.Relprev!");
        }
        ...
        private async Task<string> GetAccessTokenAsync(HttpClient client, string userName, string password)
        {
            ...
            var response = await client.RequestPasswordTokenAsync(new PasswordTokenRequest
            {
                ...
                Scope = "Infraero.Relprev.WebUIAPI openid profile",
                UserName = userName,
                Password = password
            });
        ...
        public static void SeedSampleData(ApplicationDbContext context)
        {
            context.Usuarios.AddRange(
                new Usuario { Id = 1, Title = "Do this thing." }                
            );
