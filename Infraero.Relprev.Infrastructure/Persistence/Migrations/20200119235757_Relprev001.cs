        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlteradoPor = table.Column<string>(nullable: true),
                    DataAlteracao = table.Column<DateTime>(nullable: true),
                    NomPerfil = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResponsavelTecnicoCodResponsavelTecnico = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ResponsavelTecnicoCodResponsavelTecnico,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumTelefone = table.Column<string>(nullable: true),
                    CodUnidadeInfraestrutura = table.Column<int>(nullable: false),
                    UnidadeInfraestruturaCodUnidadeInfraestrutura = table.Column<int>(nullable: true),
                    CodPerfil = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.UnidadeInfraestruturaCodUnidadeInfraestrutura,
                        principalTable: "UnidadeInfraestrutura",
                        principalColumn: "CodUnidadeInfraestrutura",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DscRelato = table.Column<string>(nullable: true),
                    CodUnidadeInfraestrutura = table.Column<int>(nullable: false),
                    AmbienteCodAmbiente = table.Column<int>(nullable: true),
                    SituacaoRelatoCodSituacaoRelato = table.Column<int>(nullable: true),
                    SubAmbienteCodSubAmbiente = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.AmbienteCodAmbiente,
                        principalTable: "Ambiente",
                        principalColumn: "CodAmbiente",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
